...
void ffree(char **);
void *reall_mem(void *, unsigned int, unsigned int);
...
int is_chain_deli(info_t *, char *, size_t *);
void check_chain_cont(info_t *, char *, size_t *, size_t, size_t);
